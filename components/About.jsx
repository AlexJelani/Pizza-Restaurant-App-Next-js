...
function About() {
    ...
    // Define a variable for the background image URL
    const backgroundImageStyle = {
        // backgroundImage: `url(${svgDataUrl})`, // Use the SVG data URL as the background image
        backgroundSize: 'cover',
        backgroundRepeat: 'repeat',
        backgroundColor: '#fffcba',
    };
    // Define additional class name
    ...
    return (
        <section className={`w-full xl:h-screen 2xl:h-screen flex items-center mt-2 ${bgwrapper}`} id='about'>
            ...
            <div className='w-full md:grid grid-cols-2 gap-5' style={backgroundImageStyle}>
